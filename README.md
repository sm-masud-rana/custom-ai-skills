...
Reusable, plug-and-play AI skills for marketing and productivity. Each skill is a simple markdown file you can paste into ChatGPT, Gemini, Claude, or agent tools like Hermes and OpenClaw to make the AI act like a focused expert.
...
1. Open any skill folder and copy its `SKILL.md`.
2. Paste it as the system prompt / custom instructions in your AI tool.
3. Give your input — the AI now behaves like that expert.

**For Hermes / OpenClaw:** drop the `SKILL.md` file into your agent's skills folder.
**For ChatGPT / Gemini / Claude:** paste `SKILL.md` into custom instructions or a new chat.
